	...
	<Card.Root>
		...
		>
			<Card.Content class="space-y-4">
				<div>
					<Card.Title>Tambah Gudang Baru</Card.Title>
					<Card.Description>Masukkan informasi dasar untuk gudang baru Anda.</Card.Description>
				</div>
...
<NotificationDialog
	...
	type="success"
	title="Berhasil"
	description={form?.message || 'Gudang berhasil ditambahkan'}
	onAction={() => {
